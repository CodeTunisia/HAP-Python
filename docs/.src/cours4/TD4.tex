...
% !split
% ===== Exercice: Valeur approchée de $\pi$ =====
...
% 
% !split
% ===== Exercice: Intégration adaptative =====
% \label{ex:adaptatif}
% 
...
% 
% !split
% ===== Exercice: Intégration de x élevé à x =====
...
\subex{a)}
Définir une fonction \Verb!densite_radiale()!, définie entre $0$ et $\infty$ qui prend comme paramètre variable un rayon $r$ et comme paramètre par défaut $a_0 = 0.529$ $A^{\circ}$ et renvoie la valeur $4 \times \frac{r^2}{a_0^3} \times e^{-2 \times \frac{r}{a_0}}$.
