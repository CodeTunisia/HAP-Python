...
\fancypagestyle{plain}{
  \fancyhf{}
  \fancyfoot[C]{{\footnotesize \copyright\ 2020, Ahmed Ammar. GPL3}}
...
{\LARGE\bf
\begin{spacing}{1.25}
TD N°1 : Les bases de la programmation avec Python
\end{spacing}
}
\end{center}
...
\begin{center}
{\bf Ahmed Ammar${}^{1}$ (\texttt{ahmed.ammar@fst.utm.tn})} \\ [0mm]
\end{center}


\begin{center}
{\bf Soumaya Darragi${}^{1}$ (\texttt{soumaya.darragi@gmail.com})} \\ [0mm]
\end{center}

\begin{center}
% List of all institutions:
\centerline{{\small ${}^1$Institut Préparatoire aux Études Scientifiques et Techniques, Université de Carthage.}}
\end{center}
...
\exercisesection{Exercice \thedoconceexercisecounter: Les variables}
...
\exercisesection{Exercice \thedoconceexercisecounter: Fonction \texttt{input()} }
